...
export const mentionStyle =
  "rounded-[3px] px-[2px] font-medium [unicode-bidi:plaintext] bg-blurple/30 text-blurple-260 transition-colors transition-[50ms]";
const actionableMentionStyle = twMerge(
  mentionStyle,
  "cursor-pointer hover:bg-blurple hover:text-white",
);
...
export const codeStyle =
  "my-[-0.2em] size-auto whitespace-pre-wrap rounded-[3px] p-[0.2em] indent-0 font-code text-[length:0.85em] leading-[calc(var(--font-size)*1.125)] bg-primary-630";
